...
var HomeController = function($rootScope, $scope, FeedService, InstagramService, $route, $routeParams, $location, data, app, appName, $sce, $q) {
    ...
    angular.element('body').addClass('homehero');
    ...
    $scope.$on('$viewContentLoaded', function() {
        angular.element('.carousel-control').on('click', function(e) {
            e.preventDefault();
            console.log('click');
        });
        setTimeout(function() {
