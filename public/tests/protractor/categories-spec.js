describe('categories', function() {
    ...
    it('should have a functioning menu', function() {
        ...
        navTexts.then(function(array) {
            ...
            //element.all(by.repeater('item in navItems')).get(0).element(by.linkText('INSANE STUNTS')).click();
            //it('should have feed items', function() {
            ...
            //element.all(by.repeater('item in navItems')).get(1).element(by.linkText('CRASH & BURN')).click();
            //it('should have feed items', function() {
            ...
            //element.all(by.repeater('item in navItems')).get(2).element(by.linkText('GAMING')).click();
            //it('should have feed items', function() {
            ...
            //element.all(by.repeater('item in navItems')).get(3).element(by.linkText('SPORTS CAR')).click();
            //it('should have feed items', function() {
            //    browser.get('http://local.altdriver.com:3000/gaming/');
            //
            //    //element(by.model('todoList.todoText')).sendKeys('write first protractor test');
            ...
            //element.all(by.repeater('item in navItems')).get(4).element(by.linkText('LUX')).click();
            //it('should have feed items', function() {
            ...
            //element.all(by.repeater('item in navItems')).get(5).element(by.linkText('MOTORCYCLES')).click();
            //it('should have feed items', function() {
            ...
            //element.all(by.repeater('item in navItems')).get(6).element(by.linkText('CLASSICS')).click();
            //it('should have feed items', function() {
            ...
            //element.all(by.repeater('item in navItems')).get(7).element(by.linkText('OFF ROAD')).click();
            //it('should have feed items', function() {
